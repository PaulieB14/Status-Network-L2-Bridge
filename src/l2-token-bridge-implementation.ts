...
import {
  ...
  BridgingFinalizedV2 as BridgingFinalizedV2Event,
  NewTokenDeployed as NewTokenDeployedEvent
} from "../generated/L2TokenBridgeImplementation/L2TokenBridge"
import {
  BridgingInitiatedV2,
  BridgingFinalizedV2,
  NewTokenDeployed,
...
export function handleBridgingFinalizedV2(event: BridgingFinalizedV2Event): void {
  let entity = new BridgingFinalizedV2(
    event.transaction.hash.concat(Bytes.fromI32(event.logIndex.toI32()))
  )
